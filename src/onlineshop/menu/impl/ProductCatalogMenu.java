...
public class ProductCatalogMenu implements Menu {
  ...
  public void start() {
    ...
    while (true) {
      ...
      if (context.getLoggedInUser() == null) {
        ...
        System.out.println(
          "You are not logged in. Please, sign in or create new account"
        );
        break;
      }
  ...
  private Product fetchProduct(String userInput) {
    ...
    Product productToAddToCart = productManagementService.getProductById(
